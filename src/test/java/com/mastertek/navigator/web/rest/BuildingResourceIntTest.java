...
public class BuildingResourceIntTest {
    ...
    public void createBuilding() throws Exception {
        ...
        assertThat(testBuilding.getLat()).isEqualTo(DEFAULT_LAT);
        assertThat(testBuilding.getLng()).isEqualTo(DEFAULT_LNG);
    }
    ...
    public void updateBuilding() throws Exception {
        ...
        assertThat(testBuilding.getLat()).isEqualTo(UPDATED_LAT);
        assertThat(testBuilding.getLng()).isEqualTo(UPDATED_LNG);
    }
